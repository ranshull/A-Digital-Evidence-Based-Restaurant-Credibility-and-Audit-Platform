...
from ..views.superadmin_views import (
    ...
    SuperAdminRollbackAuditPublishView,
...
urlpatterns = [
    ...
    path(
        'rollback-audit-publish/<int:work_item_id>/',
        SuperAdminRollbackAuditPublishView.as_view(),
        name='superadmin_rollback_audit_publish',
    ),
